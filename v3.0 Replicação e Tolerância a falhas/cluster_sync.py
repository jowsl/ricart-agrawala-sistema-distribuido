...
import json
import sys
from configuracoes import NOS, STORES
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
        ...
        while True:
            ...
            try:
                ...
                #Cliente manda "ESCRITA" -- "Quero acessar"
...
def ping():
    ...
    while True:
        for store in STORES:
            ...
            try:
                with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
                    s.settimeout(2) #se demorar mais de 2, assumimos que caiu.
...
def iniciar():
    ...
    #liga nosso heartbeat em tread separada
